...
const rules = document.querySelector('.rulessection');

openRules.addEventListener('click', function () {
  rules.classList.remove('hiderules');
  overlay.classList.remove('hiderules');
});

overlay.addEventListener('click', function () {
  overlay.classList.add('hiderules');
  rules.classList.add('hiderules');
});

document.addEventListener('keydown', function (e) {
  if (e.key === 'Escape') {
    if (!openRules.classList.contains('hiderules')) {
      overlay.classList.add('hiderules');
      rules.classList.add('hiderules');
    }
  }
